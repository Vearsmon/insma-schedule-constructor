...
public static partial class AcademicDisciplineMappingRegister
{
    ...
    public static DbAcademicDiscipline? MapModelToEntity(AcademicDiscipline? model)
    {
        ...
        entity.AcademicDisciplineLectureLessonBatchInfos = model.LecturePayload?.LessonBatchInfos.Select(LessonBatchInfoMappingRegister.MapModelToEntity).ToArray()!;
        entity.PracticeTotalHoursCount = model.PracticePayload?.TotalHoursCount;
        entity.AcademicDisciplinePracticeLessonBatchInfos = model.PracticePayload?.LessonBatchInfos.Select(LessonBatchInfoMappingRegister.MapModelToEntity).ToArray()!;
        entity.LabTotalHoursCount = model.LabPayload?.TotalHoursCount;
        entity.AcademicDisciplineLabLessonBatchInfos = model.LabPayload?.LessonBatchInfos.Select(LessonBatchInfoMappingRegister.MapModelToEntity).ToArray()!;
        entity.AcademicDisciplineExamLessonBatchInfos = model.ExamPayload?.LessonBatchInfos.Select(LessonBatchInfoMappingRegister.MapModelToEntity).ToArray()!;
        entity.AcademicDisciplineTestLessonBatchInfos = model.TestPayload?.LessonBatchInfos.Select(LessonBatchInfoMappingRegister.MapModelToEntity).ToArray()!;
