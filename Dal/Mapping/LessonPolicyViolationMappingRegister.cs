...
public static partial class LessonPolicyViolationMappingRegister
{
    ...
    [MapProperty($"{nameof(LessonPolicyViolation.Payload)}.{nameof(LessonPolicyViolation.Payload.AffectedByTeacher)}", nameof(DbLessonPolicyViolation.AffectedByTeacher))]
